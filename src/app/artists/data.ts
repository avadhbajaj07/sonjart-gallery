export const artistsData = [
  {
    ...
    bio: `Geboren am 10. August 1934. Lebt und arbeitet in Baar / Zug. Tätig als Kunstmaler und Designer. Seit 1970 regelmässig Ausstellungen im In- und Ausland. In Amerika, Russland, Ungarn, Deutschland und Finnland. Zahlreiche Wettbewerbe und soziale Events in Schulen und öffentlichen Institutionen. September 2003 erhielt der Kunstschaffende den Kulturpreis der Stadt Zug. Diverse Publikationen (Kunstbuch, Kinderbücher). Gestaltung des Zürich-Trams “Schlaraffenland” sowie Preisträger des internationalen Briefmarkenwettbewerbes der japanischen Staatspost. Phantasievoll, humorvoll und voller Lebensfreude, entstehen figurativ-abstrakte Werke, die von einem hohen Wieder-erkennungswert geprägt sind. Den Geschöpfen, die auf der Leinwand entstehen, verleiht er menschliche Ausdrücke, die zum Schmunzeln anregen. Für den Betrachter sind seine Werke erfrischend, spontan und zugleich emotional wahrnehmbar.`
  },
  {
    id: 'beatrice-jud',
    name: 'Beatrice Jud',
