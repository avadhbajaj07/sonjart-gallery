  ...
  return (
    <main style={{ paddingTop: '8rem', paddingBottom: 'var(--spacing-xl)', minHeight: '100vh' }} className="container fade-in">
      ...
      <div style={{ color: 'var(--color-grey-medium)', lineHeight: 1.8 }}>
        ...
        <p style={{ marginBottom: '1.5rem' }}>By using this website, you agree to these Terms & Conditions. All content, imagery, and design elements are the property of sonjART or our represented artists and are protected by copyright law.</p>
